...
const navItems = [
  ...
  { label: "Patient Test", href: "/patient-test", isRoute: true },
  { label: "Patient API", href: "/patient-profile", isRoute: true },
  { label: "Doctor API", href: "/doctor-dashboard", isRoute: true },
];
